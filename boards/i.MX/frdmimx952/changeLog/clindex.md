...
```{include} /examples/_boards/frdmimx952/ChangeLog_board.md
:heading-offset: 2
```
---
...
```
---
```{include} /drivers/audmix/doxygen/ChangeLog_audmix.md
:heading-offset: 2
```
---
...
```
---
```{include} /drivers/mipi_dsi2_dwc/doxygen/ChangeLog_mipi_dsi.md
:heading-offset: 2
```
---
