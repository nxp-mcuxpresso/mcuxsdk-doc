...
The MCUXpresso SDK FRDM i.MX 952 release supports building and debugging with the toolchains listed in [Table 1](#frdmimx952_TABLE_TOOLCHAININFO).
...
(frdmimx952_TABLE_TOOLCHAININFO)=
...
-   To support FRDM i.MX 952, the patch for IAR and Segger J-Link must be installed. To get the patch, contact your local field applications engineer \(FAE\) or the sales representative.
