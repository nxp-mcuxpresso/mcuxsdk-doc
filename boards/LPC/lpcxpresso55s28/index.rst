...
The LPC5500 series is fully supported by NXPs` \ `MCUXpresso suite <https://www.nxp.com/design/design-center/software/development-software/mcuxpresso-software-and-tools-:MCUXPRESSO?tid=vanmcuxpresso>`__\  of free software and tools, which include an Eclipse-based IDE, configuration tools and extensive SDK drivers/examples available at \ `https://mcuxpresso.nxp.com <https://mcuxpresso.nxp.com/>`__\. MCUXpresso SDK includes project files for use with IDEs from lead partners Keil and IAR.
