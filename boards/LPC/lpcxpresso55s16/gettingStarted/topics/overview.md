...
For supported toolchain versions, see *MCUXpresso SDK Release Notes* \(document MCUXSDKRN\). *MCUXpresso SDK Release Notes for LPCXpresso55S16* \(document MCUXSDKLPC551XRN\).
