...
The MCUXpresso SDK supports various hardware platforms that come loaded with various factory programmed debug interface configurations. [Table 1](#evkmimxrt685_TABLE_UVC_BLB_DR_20REL4) lists the hardware platforms supported by the MCUXpresso SDK, their default debug interface, and any version information that helps differentiate a specific interface configuration.

**Note:** The [OpenSDA details](#evkmimxrt685_COLUMNC) column in [Table 1](#evkmimxrt685_TABLE_UVC_BLB_DR_20REL4) is not applicable to LPC.

(evkmimxrt685_COLUMNC)=
(evkmimxrt685_TABLE_UVC_BLB_DR_20REL4)=
