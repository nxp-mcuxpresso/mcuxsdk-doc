...
-   The following three macros are added in `flexspi_nor` targets to support XIP, as described in [Table 1](#evkbmimxrt1170_TABLE_HBQ_GX5_5CB).

    (evkbmimxrt1170_TABLE_HBQ_GX5_5CB)=
...
-   [Table 2](#evkbmimxrt1170_TABLE_YK2_PX5_5CB) shows the different effect on the built image with a different combination of these macros.

    (evkbmimxrt1170_TABLE_YK2_PX5_5CB)=
