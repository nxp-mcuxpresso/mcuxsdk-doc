...
2.  On the **Quickstart Panel**, click **Import SDK example\(s\)…**, as shwon in [Figure 2](#evkmimxrt1020_IMPORTANSDKEXAMPLE).

(evkmimxrt1020_IMPORTANSDKEXAMPLE)=
    ![](../images/import_sdk_example.png "Import an SDK example")

3.  In the window that appears, expand the **MIMXRT1020** folder and select **MIMXRT1021xxxxx**. Then, select **evkmimxrt1020** and click **Next**, as shown in [Figure 3](#evkmimxrt1020_SELECTBOARD).

(evkmimxrt1020_SELECTBOARD)=
    ![](../images/select_evk-imxrt1020_board.jpg "Selecting MIMXRT1020-EVK board")

4.  Expand the `demo_apps` folder, select `hello_world`, and then click **Next**, as shown in [Figure 4](#evkmimxrt1020_SELECTHELLOWORLDCASE).

(evkmimxrt1020_SELECTHELLOWORLDCASE)=
