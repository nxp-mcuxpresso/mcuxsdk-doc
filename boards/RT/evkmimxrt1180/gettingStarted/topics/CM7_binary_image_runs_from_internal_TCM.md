...
2.  Use `Additional images` to specify CM7 application image running from ITCM memory. See [Table 1](CM7_binary_image_runs_from_internal_TCM.md#table_para) for how to fill in necessary information for this additional image.
