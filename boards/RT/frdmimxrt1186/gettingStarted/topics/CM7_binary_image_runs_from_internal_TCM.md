...
2.  Use `Additional images` to specify CM7 application image running from ITCM memory. See [Table 1](#frdmimxrt1186_table_para) for how to fill in necessary information for this additional image.
