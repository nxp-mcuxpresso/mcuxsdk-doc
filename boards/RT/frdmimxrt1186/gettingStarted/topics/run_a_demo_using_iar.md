...
Both CMSIS‑DAP and J‑Link debugging interfaces are supported in the IAR IDE. Although not mandatory, it is recommended to reset the board before each download or debug session. 
