...
3.  To debug the application, click the **Start/Stop Debug Session** button or **Ctrl** + **F5**, highlighted in [Figure 2](#frdmimxrt1186_FIG_STOPATMAIN).

    (frdmimxrt1186_FIG_STOPATMAIN)=
    ![](../images/keil_stop_at_main.png "Stop at main() when run debugging")

4.  Run the code by clicking **Run** to start the application, as shown in [Figure 3](#frdmimxrt1186_FIG_RUNBUTTON).

    (frdmimxrt1186_FIG_RUNBUTTON)=
    ![](../images/keil_run_button.png "Run button")

    The `hello_world` application is now running and a banner is displayed on the terminal, as shown in [Figure 4](#frdmimxrt1186_FIG_TEXTDISPLAY). If this is not true, check your terminal settings and connections.

    (frdmimxrt1186_FIG_TEXTDISPLAY)=
