...
See [Figure 1](ide_run_a_multicore_example_application.md#FIG_DEBUGHELLOWORLD) to [Figure 3](ide_run_a_multicore_example_application.md#FIG_STOPPRIMARYCORE) for reference.
