...
-   The following three macros are added in `flexspi_nor` targets to support XIP, as described in [Table 1](#evkmimxrt1015_TABLE_HBQ_GX5_5CB).

    ^

(evkmimxrt1015_TABLE_HBQ_GX5_5CB)=
...
-   [Table 2](#evkmimxrt1015_TABLE_YK2_PX5_5CB) shows the different effect on the built image with a different combination of these macros.

    ^

(evkmimxrt1015_TABLE_YK2_PX5_5CB)=
