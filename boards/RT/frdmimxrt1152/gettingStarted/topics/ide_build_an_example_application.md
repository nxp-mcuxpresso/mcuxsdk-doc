...
3.  In the window that appears, select **MIMXRT1152xxxxx**. Then, select **frdmimxrt1152** and click **Next**.

    ![](../images/ide_select_frdmimxrt1152_board.png "Select FRDM-IMXRT1152 board")
