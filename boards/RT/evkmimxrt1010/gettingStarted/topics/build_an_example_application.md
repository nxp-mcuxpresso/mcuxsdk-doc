...
4.  Expand the `demo_apps` folder, select `hello_world`, and then click **Next**, as shown in [\#SELECTHELLOWORLDCASE](build_an_example_application.md#SELECTHELLOWORLDCASE).
