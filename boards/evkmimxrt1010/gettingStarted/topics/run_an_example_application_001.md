...
5.  The target device selection chosen for this example is **MIMXRT1011DAE5A**.
6.  After it is connected, the screen should resemble [Figure 2](run_an_example_application_001.md#SEGGERJLINKGDBSERVERSUCCESS0000).
    ...
    ![](../images/figure23.png "SEGGER J-Link GDB Server screen after successful
                connection")
