...
1.  Open the desired demo application workspace. Most example application workspace files can be located using the following path:
    ...
    Using the MIMXRT1040-EVK hardware platform as an example, the `hello_world` workspace is located in:

    ```
    <install_dir>/boards/evkmimxrt1040/demo_apps/hello_world/iar/hello_world.eww
    ```
