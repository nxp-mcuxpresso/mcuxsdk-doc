...
```{include} /examples/_boards/frdmk32l2a4s/ChangeLog_board.md
:heading-offset: 2
```
---
...
```
---
```{include} /devices/Kinetis/K32L/K32L2A41A/drivers/doxygen/ChangeLog_clock.md
:heading-offset: 2
```
---
...
```
---
```{include} /drivers/tsi/tsi_v4/doxygen/ChangeLog_tsi_v4.md
:heading-offset: 2
```
---
