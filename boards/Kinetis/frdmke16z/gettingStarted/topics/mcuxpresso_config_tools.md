...
[Table 1](#frdmke16z_TABLE_E1V_M1C_CDB) describes the tools included in the MCUXpresso Config Tools.

(frdmke16z_TABLE_E1V_M1C_CDB)=
...
-   **Standalone version** available for download from [www.nxp.com/mcuxpresso](https://www.nxp.com/design/design-center/software/development-software/mcuxpresso-software-and-tools-:MCUXPRESSO?tid=vanmcuxpresso). Recommended for customers using IAR Embedded Workbench, Keil MDK µVision, or Arm GCC.
