...
The MCUXpresso SDK supports various hardware platforms that come loaded with a variety of factory programmed debug interface configurations. [Table 1](#twrkm35z75m_TABLE_UVC_BLB_DR_20REL4) lists the hardware platforms supported by the MCUXpresso SDK, their default debug interface, and any version information that helps differentiate a specific interface configuration.

**Note:** The [OpenSDA details](#twrkm35z75m_COLUMNC) column in [Table 1](#twrkm35z75m_TABLE_UVC_BLB_DR_20REL4) is not applicable to LPC.

(twrkm35z75m_COLUMNC)=
(twrkm35z75m_TABLE_UVC_BLB_DR_20REL4)=
