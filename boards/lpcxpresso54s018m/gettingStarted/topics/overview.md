...
For supported toolchain versions, see *MCUXpresso SDK Release Notes for LPCXpresso540XX* \(document MCUXSDKLPC540XXRN\). After opening `SDK_2.6.0_LPCXpresso54018\docs`, consult the *MCUXpresso SDK Release Notes\_LPC540XX*.
