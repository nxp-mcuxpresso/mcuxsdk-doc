:pdf-download: ../../../_assets/boards/frdmmcxc162/mcuxsdk-frdmmcxc162.pdf
.. _frdmmcxc162:
...
FRDM-MCXC162 are compact and scalable development boards for rapid prototyping of
MCX A57X MCUs. They offer industry standard headers for easy access to the MCUs I/Os,
...
For debugging the MCXC162 MCU, the FRDM-MCXC162 board uses an onboard (OB) debug probe, MCU-Link lite
OB, which is based on another NXP MCU: LPC55S16

.. image:: ./frdmmcxc162.png
   :width: 240px
   :align: center
   :alt: FRDM-MCXC162
