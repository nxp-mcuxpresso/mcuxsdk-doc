# Getting Started with MCUXpresso SDK for FRDM-MCXW72
...
-   [Running a demo application using IAR](topics/running_a_demo_application_using_iar.md)
...
-   [How to set the board to the Bootloader ISP mode](topics/how_to_set_the_board_to_bootloader.md)
