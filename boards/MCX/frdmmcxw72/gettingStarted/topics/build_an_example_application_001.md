...
3.  In the window that appears, expand the **MCXW7XX** folder and select **MCXW726CxxxA**. Then, select **frdmmcxw72** and click **Next**.

    ![](../images/ide_selecting_k32w148_board.png "Select the frdmmcxw72 board")
