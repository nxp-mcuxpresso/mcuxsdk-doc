...
3.  In the window that appears, expand the **MCXW7XX** folder and select **MCXW716CxxxA**. Then, select **mcxw71evk** and click **Next**.

    ![](../images/ide_selecting_kw4x_board.png "Select the mcxw71evk board")
