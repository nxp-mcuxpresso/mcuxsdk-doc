:pdf-download: ../../../_assets/boards/frdmmcxa366/mcuxsdk-frdmmcxa366.pdf
.. _frdmmcxa366:
...
For debugging the MCXA346 MCU, the FRDM-MCXA366 board uses an onboard (OB) debug probe, MCU-Link lite
OB, which is based on another NXP MCU: LPC55S16

.. image:: ./frdmmcxa366.png
   :width: 240px
   :align: center
   :alt: FRDM-MCXA366
