...
To support [Componentization](./Software_Componentization.md) and [Complex Dependency](./Dependency.md), we introduce some customized Kconfig symbol definitions with the following namings:
