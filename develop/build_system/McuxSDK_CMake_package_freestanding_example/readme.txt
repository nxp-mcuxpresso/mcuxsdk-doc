...
1. With cmake cmd "cmake -B ./build -G Ninja -Dboard=frdmk22f -DCONF_FILE=<repo root>/docs/develop/build_system/McuxSDK_CMake_package_freestanding_example/prj.conf -DCMAKE_BUILD_CONFIG=debug -DCONFIG_TOOLCHAIN=armgcc", then cd into "build" folder and run "ninja".
