...
In addition, `hyperram_txt` targets can't debug on IAR versions: 9.50.1, 9.50.2, 9.60.1. The resolution is: delete the selected contents as shown in Figure 1 in IAR path: *arm\\config\\flashloader\\NXP\\FlashIMXRT1180-EVK\_FlexSPI\_M33.board*.
