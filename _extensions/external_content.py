...
def adjust_includes(
    ...
    if fname.suffix != ".rst" or fname.suffix != ".md" or fname.suffix != ".readme":
        return
...
def sync_contents(app: Sphinx) -> None:
    ...
    for content in app.config.external_content_contents:
        ...
        for src in prefix_src.glob(glob):
            if src.is_dir() and not str(src).endswith(".git"):
                to_copy.extend(
...
def setup(app: Sphinx) -> Dict[str, Any]:
    ...
    print("set up external_content extension")
