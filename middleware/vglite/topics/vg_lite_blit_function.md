...
-   The blit function can be used with or without the blend function \([vg\_lite\_blend\_t](vg_lite_blend_t_enumeration.md)\)
-   The blit function can be used with or without specifying a foreground color value \([vg\_lite\_color\_t](vg_lite_color_t_parameter.md)\)
